      ...
      >
        {
          ...
          (
            <div className="">
              <div className="m-auto overflow-hidden relative h-60 w-60">
                  <Image layout="fill" objectFit="cover" src={`/${noImg2}`} alt="" />
              </div>
              <div className=" text-center w-full h-full my-4" >
          ...
          : 
          isYes == 2 ?
          <AfterTwo setisYes={setisYes} setnoBG={setnoBG} noBG={noBG} />
          : 
          isYes == 3 ?
          <AfterThree setisYes={setisYes} setnoBG={setnoBG} noBG={noBG} />
          : 
          (
